...
bb = ones(1,2)*0.97; %ones(1,3)/3; xs
aa = [1, - 0.95]; %[1, 0, 0]; % zeros because 2nd order system and there is no y[n-1] and y[n-2] terms
...
bb
zz
freqz(bb,aa, 2000, 22050)          % frequency response, look documentation for freqz for more info